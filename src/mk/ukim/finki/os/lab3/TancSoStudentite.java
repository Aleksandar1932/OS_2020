...
public class TancSoStudentite {
    ...
    public static Semaphore mGarderoba;
    public static Semaphore zGarderoba;
    public static Semaphore sala;
    public static Semaphore wHere;
    public static Semaphore ready;
    public static Semaphore stopDance;

    public void init() {
        //TODO: da se implementira
        mGarderoba = new Semaphore(10);
        zGarderoba = new Semaphore(10);
        sala = new Semaphore(3);

        wHere = new Semaphore(0);
        ready = new Semaphore(0);
        stopDance = new Semaphore(0);
